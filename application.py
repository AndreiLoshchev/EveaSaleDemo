...
def my_form_post():
    ...
    if len(df2.week_no) > 51:
        ...
        week_no = predicted_future_sales2['index'].dt.isocalendar().week
        ...
        ax1.plot(viz_df.sales_amount, label='Actual Sales')
        ax1.plot(viz_df.yhat_scaled,color='green', label='Forecasted Sales')
